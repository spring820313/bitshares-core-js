...
function _broadcast(was_broadcast_callback){
    return new Promise((resolve, reject)=> {
        ...
        var strJson = '{"expiration" : "2018-07-13T04:14:30","extensions" : [],"operations" : [[ 0,'
                  + '{"amount" : {'
                    + '    "amount" : "100000",'
                     +  ' "asset_id" : "1.3.0"'
                     + '},'
                     ...
                     + '"memo" : {'
                      + '  "from" : "BTS6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV",'
                        + '"message" : "89b278397aa1b43d117a42ba3f6746da19274279b317a0da922b5695d57c02977f5cfee0bd5b715837bad60fc1227207",'
                        + '"nonce" : "391896005243351",'
                        + '"to" : "BTS7pxw6yQuuLksTFDhVhiMwAAgegZhQE4UsYHqxiR4CkZoj2n3Xj"'
                     + '},'
                     + '"to" : "1.2.18"'
                 + '}'
               + ']'
            + '],'
            + '"ref_block_num" : 18668,'
            + '"ref_block_prefix" : 4057291482,'
            + '"signatures" : ['
               + '"1f47c04dad2ddc35d1619e2e3244cf7ac174ab0408f961766fa9973500e9c506d93cde14130347eea32124c4b73efa75046"'
            + ']'
         + '}'

         tr_object = JSON.parse(strJson); 
