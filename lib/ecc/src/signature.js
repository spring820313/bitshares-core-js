var { sign, recoverPubKey, verify, calcPubKeyRecoveryParam } = require('./ecdsa');
...
class Signature {
    ...
    */
    static signBuffer(buf, private_key) {
        var buf2 = new Buffer('2',  'utf-8')
        var _hash = sha256(buf2);
        console.log(private_key.toHex())
    ...
    */
    static signBufferSha256(buf_sha256, private_key) {
        ...
        var strR = ecsignature.r.toHex()
        var strS = ecsignature.s.toHex()
